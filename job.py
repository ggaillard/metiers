    ...
    "Infrastructure et gestion des données": {
        "Architecte de données": {
            "Compétences techniques": [
                ...
                "Être à l'aise avec les outils de gestion de données"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Ingénieur(e) Big Data": {
            "Compétences techniques": [
                "Gérer et exploiter de très grands volumes de données",
                "Savoir utiliser les outils de Big Data",
                "Être à l'aise avec les bases de données distribuées"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Ingénieur(e) en data science": {
            "Compétences techniques": [
                "Maîtriser les techniques de traitement des données",
                "Savoir extraire des insights à partir de données",
                "Être à l'aise avec les outils de data science"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Data scientist": {
            "Compétences techniques": [
                "Maîtriser les techniques de traitement des données",
                "Savoir développer des modèles prédictifs",
                "Être à l'aise avec les outils de data science"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
        ...
        "Data analyst": {
            "Compétences techniques": [
                "Maîtriser les techniques d'analyse des données",
                "Savoir utiliser les outils de visualisation de données",
                "Être à l'aise avec les bases de données"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Ingénieur(e) en intelligence artificielle": {
            "Compétences techniques": [
                "Maîtriser les techniques d'intelligence artificielle",
                "Savoir développer des systèmes intelligents",
                "Être à l'aise avec les outils d'IA"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
    ...
    "Sécurité informatique et conformité": {
        "Consultant(e) en sécurité informatique": {
            "Compétences techniques": [
                ...
                "Être à l'aise avec les outils de sécurité"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Technicien(ne) en cybersécurité": {
            "Compétences techniques": [
                "Mettre en place et gérer les outils de protection",
                "Savoir diagnostiquer les incidents de sécurité",
                "Être à l'aise avec les environnements de sécurité"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Pentester (Testeur d’intrusion)": {
            "Compétences techniques": [
                ...
                "Être à l'aise avec les outils de test d'intrusion"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
                "Être curieux(se) des nouvelles technologies",
        ...
        "Délégué(e) à la protection des données (DPO)": {
            "Compétences techniques": [
                ...
                "Savoir gérer les données personnelles",
                "Être à l'aise avec les outils de gestion de données"
            ],
            "Compétences comportementales": [
                "Aimer résoudre des problèmes complexes",
        ...
        "Consultant(e) en conformité RGPD": {
            "Compétences techniques": [
                "Conseiller les entreprises sur le RGPD",
                "Savoir gérer les données personnelles",
                "Être à l'aise avec les outils de gestion de données"
            ],
            "Compétences comportementales": [
